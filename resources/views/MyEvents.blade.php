...
<section class="py-5 py-xl-8">
    ...
    <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
            <h2 class="mb-4 display-5 text-center">My Statistics</h2>
      ...
      <div class="row gy-5 gy-md-6 gy-lg-0">
        ...
        <div class="col-6 col-lg-3">
          <div class="text-center">
            ...
            <div class="d-flex align-items-center justify-content-center bg-primary mb-3 mx-auto "style="height=50%">
            ...
            <h5 class="display-6 fw-bold m-1">{{ $createdEvents->count() }}</h5>
            <p class="text-secondary m-0">Total Events</p>
          </div>
        </div>
        <div class="col-6 col-lg-3">
          <div class="text-center">
    ...
    <table class="table align-middle mb-0 bg-white">
        ...
        <tbody>
         ...
         {{-- Ajoutez d'autres conditions pour d'autres statuts si nécessaire --}}
         @else
             {{-- Si aucun des statuts correspond, affichez un badge par défaut --}}
